// ignore_for_file: unnecessary_new, unrelated_type_equality_checks
...
// import 'package:mountain_path/bottom_navigation_bar.dart';
...
class _DownloadFileState extends State<DownloadFile> {
  final _documents = [
    {'name': 'Test', 'link': 'https://www.sriramana.org/mpath/2004_I_Jan.pdf'},
  ];
  ...
  void initState() {
    super.initState();
    // FlutterDownloader.initialize(debug: debug, ignoreSsl: true);
            ...
            data!.task!.status == DownloadTaskStatus.running ||
                ...
                ? Positioned(
                    ...
                    child: LinearProgressIndicator(
                      backgroundColor: Color.fromARGB(255, 162, 162, 122),
                      color: Colors.yellow,
