...
class FridaySongsPage extends StatefulWidget {
  const FridaySongsPage({super.key});

  @override
  State<FridaySongsPage> createState() => _FridaySongsPageState();
}

class _FridaySongsPageState extends State<FridaySongsPage> {
  @override
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                  itemCount: tamil_songs_list[4].length,
                        ...
                        child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                    selectedLanguage == "Tamil"
                                        ? tamil_songs_list[4][index]
                                        : eng_songs_list[4][index],
                                    style: TextStyle(
                                        color: Colors.white,
