...
class TuesdaySongsPage extends StatefulWidget {
  const TuesdaySongsPage({super.key});

  @override
  State<TuesdaySongsPage> createState() => _TuesdaySongsPageState();
}

class _TuesdaySongsPageState extends State<TuesdaySongsPage> {
  @override
