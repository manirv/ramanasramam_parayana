...
class MondaySongsPage extends StatefulWidget {
  const MondaySongsPage({super.key});

  @override
  State<MondaySongsPage> createState() => _MondaySongsPageState();
}

class _MondaySongsPageState extends State<MondaySongsPage> {
  @override
